...
if ( ! function_exists( 'csco_misc_social_links' ) ) {
	 ...
	 */
       function csco_misc_social_links( $settings = array() ) {
               ...
               if ( $social_1_image && function_exists( 'attachment_url_to_postid' ) ) {
               ...
               if ( $social_2_image && function_exists( 'attachment_url_to_postid' ) ) {
               ...
               if ( $social_3_image && function_exists( 'attachment_url_to_postid' ) ) {
               ...
               if ( $social_4_image && function_exists( 'attachment_url_to_postid' ) ) {
               ...
               if ( $social_5_image && function_exists( 'attachment_url_to_postid' ) ) {
